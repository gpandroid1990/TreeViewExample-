...
/**
 * 该类为TreeViewAdapter的改写，主要是为了解决当点击一个节点时，默认展开，折叠该节点
 * 改写之后，节点的展开，折叠需要自己去处理
 */
public class Tree_CustomTreeViewAdapter extends RecyclerView.Adapter<TreeViewHolder> {
     ...
     */
    public Tree_CustomTreeViewAdapter(TreeViewHolderFactory factory) {
     ...
     */
    public Tree_CustomTreeViewAdapter(TreeViewHolderFactory factory, TreeNodeManager manager) {
        this.treeViewHolderFactory = factory;
